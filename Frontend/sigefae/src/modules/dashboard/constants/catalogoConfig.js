export const catalogoConfig = {
  ...
  "reglas-monto":    { endpoint: "regla-monto-ruta",label: "Regla de Monto",    method: "PUT",   fields: ["monto_minimo", "moneda_id", "posicion_insercion", "prioridad", "usuario_aprobador_id"] },
