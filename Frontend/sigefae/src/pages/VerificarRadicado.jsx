...
export default function VerificarRadicado() {
  ...
  const [radicadoCollapsed, setRadicadoCollapsed] = useState(false);
  const [documentoCollapsed, setDocumentoCollapsed] = useState(false);
  const [partesCollapsed, setPartesCollapsed] = useState(false);
  const [cufeCollapsed, setCufeCollapsed] = useState(false);
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          <div className={styles.cardHeader} role="button" tabIndex={0} onClick={() => setRadicadoCollapsed(!radicadoCollapsed)}>
            <div className={styles.cardIcon}>
              <i className="fa-solid fa-stamp"></i>
            </div>
              <h3 className={styles.cardTitle}>Información del Radicado</h3>
              <div className={`${styles.toggleIcon} ${radicadoCollapsed ? styles.collapsed : ""}`}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <polyline points="6 9 12 15 18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
          </div>
            <div className={styles.grid} style={{ display: radicadoCollapsed ? 'none' : undefined }}>
        ...
        {/* Documento Comercial */}
        <div className={styles.card}>
            <div className={styles.cardHeader} role="button" tabIndex={0} onClick={() => setDocumentoCollapsed(!documentoCollapsed)}>
            <div className={styles.cardIcon}>
              <i className="fa-solid fa-file-invoice"></i>
            </div>
            <h3 className={styles.cardTitle}>Documento Comercial</h3>
            <div className={`${styles.toggleIcon} ${documentoCollapsed ? styles.collapsed : ""}`}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <polyline points="6 9 12 15 18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className={styles.grid} style={{ display: documentoCollapsed ? 'none' : undefined }}>
            <div className={styles.field}>
        ...
        {/* Partes */}
        <div className={styles.card}>
            <div className={styles.cardHeader} role="button" tabIndex={0} onClick={() => setPartesCollapsed(!partesCollapsed)}>
            <div className={styles.cardIcon}>
              <i className="fa-solid fa-building"></i>
            </div>
            <h3 className={styles.cardTitle}>Partes del Documento</h3>
            <div className={`${styles.toggleIcon} ${partesCollapsed ? styles.collapsed : ""}`}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <polyline points="6 9 12 15 18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className={styles.grid} style={{ display: partesCollapsed ? 'none' : undefined }}>
            <div className={styles.field}>
        ...
        {data.documento.cufe && (
          <div className={styles.card}>
            <div className={styles.cardHeader} role="button" tabIndex={0} onClick={() => setCufeCollapsed(!cufeCollapsed)}>
              ...
              <div className={`${styles.toggleIcon} ${cufeCollapsed ? styles.collapsed : ""}`}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <polyline points="6 9 12 15 18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className={styles.cufeBox} style={{ display: cufeCollapsed ? 'none' : undefined }}>
