...
type Correo struct {
	...
	Para                  string               `gorm:"column:para;type:text" json:"para"`
	...
	Cc                    string               `gorm:"column:cc;type:text" json:"cc"`
	Bcc                   string               `gorm:"column:bcc;type:text" json:"bcc"`
	ReplyTo               string               `gorm:"column:reply_to;type:text" json:"reply_to"`
